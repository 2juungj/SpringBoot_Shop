...
<div class="container">
	<form action="/action_page.php">
		...
		<div class="form-group">
			<input type="text" class="form-control" placeholder="주소 입력" id="address">
		</div>

		<div class="form-group">
			<input type="tel" class="form-control" placeholder="전화번호 입력" id="tel">
		</div>
	</form>
	...
	<div>
		<a href="/oauth2/authorization/kakao"><img height="38px" src="/image/kakao_login_button.png" /></a> <a href="/oauth2/authorization/naver"><img height="38px" src="/image/naver_login_button.png" /></a>
	</div>
