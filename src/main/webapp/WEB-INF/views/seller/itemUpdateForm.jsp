...
<div class="container">
	...
	<div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center;">
		...
		<div style="flex: 1;">
			<div>
				<label>상품명</label> <input value="${item.itemName}" type="text" class="form-control" id="itemname" required>
			</div>
			<div>
				<label>상품 가격</label> <input value="${item.price}" type="number" class="form-control" id="price" required>
			</div>
			<div>
				<label>재고 수량</label> <input value="${item.stock}" type="number" class="form-control" id="stock" required>
			</div>
			<div>
				<label>상품 설명</label> <input value="${item.itemText}" type="text" class="form-control" id="itemtext" required>
			</div>
			<br>
			<div>
